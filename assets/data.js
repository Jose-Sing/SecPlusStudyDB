const STUDY_DATA = [
  ...
  {
    "sectionId": "S13",
    "sectionTitle": "Section 13: Audits and Assessments",
    "concepts": [
      {
        "name": "Audits",
        ...
        "analogy": "*Es como una inspección oficial del departamento de salud a un restaurante: alguien externo llega con una lista de verificación y evalúa si todo está cumpliendo las normas, sin importar lo que el dueño diga sobre su propio negocio.*",
        "tables": [
          {
            "headers": [
              "Regulation",
      ...
      },
      {
        ...
        "analogy": "*Es como una revisión técnica que le hace un mecánico a tu carro antes de un viaje largo: no es para multarte, sino para identificar qué piezas pueden fallar antes de que salgas a la carretera.*",
        "tables": [],
        "list_items": [
      ...
      },
      {
        ...
        "analogy": "*Es como usar una lista de verificación para preparar un avión antes de despegar: cada ítem tiene un responsable y una respuesta clara de sí o no, porque no hay espacio para ambigüedades cuando está en juego la seguridad.*",
        "tables": [
          {
            "headers": [
              "#",
            ...
            "rows": [
              [
                "1",
                "Has the organization experienced a cybersecurity incident in the past 12 months? Have deficiencies been addressed?"
              ],
              [
                "2",
                "Is there a data security incident response plan?"
              ],
              [
                "3",
                "Is a business continuity plan established with inventory of vital operations, IT assets, and third-party agreements?"
              ],
              [
                "4",
                "Does every device have updated antivirus/anti-malware software?"
              ],
              [
                "5",
                "Is there a mobile device policy? Has staff been trained on it? Are BYOD rules defined?"
              ]
            ]
          }
        ],
      ...
      },
      {
        ...
        "analogy": "*Es como la revisión técnica vehicular obligatoria combinada con un examen de conocimiento del conductor: no solo revisan el carro, también evalúan si el conductor sabe lo que hace.*",
        "tables": [],
        "list_items": [
      ...
      },
      {
        ...
        "analogy": "*Es como pedir una segunda opinión médica a un especialista que no conoce al paciente: no tiene historia previa ni interés en quedar bien, solo dice lo que ve.*",
        "tables": [],
        "list_items": [
      ...
      },
      {
        ...
        "analogy": "*Es como preparar tu carpeta de documentos para una auditoría de impuestos: alguien externo llega, hace preguntas específicas, y tú debes tener los papeles que prueben que estás haciendo las cosas como se debe.*",
        "tables": [
          {
            "headers": [
              "Category",
            ...
            "rows": [
              [
                "**General Governance**",
                "HIPAA Privacy and Security Survey completion; Security Officer contact info"
              ],
              [
                "**Administrative Safeguards**",
                "Risk assessment at entity level; risk assessments for systems housing ePHI; risk management policy; organizational chart"
              ],
              [
                "**Physical Safeguards**",
                "Physical security policies; data destruction/media reuse procedures; role-based access lists; logs of employees by PHI access type"
              ],
              [
                "**Technical Safeguards**",
                "Encryption policies; IT monitoring controls; system-generated user access listings for PHI systems"
              ],
              [
                "**Privacy - General Governance**",
                "HIPAA privacy policy documentation; Compliance/Privacy Officer contact info"
              ],
              [
                "**HITECH**",
                "Breach notification processes; entity-level risk assessment documentation"
              ]
            ]
          }
        ],
        ...
        "tables": [
          {
            ...
            "rows": [
              [
                "**Known**",
                "Testers receive detailed info: network diagrams, IP addresses, OS versions, credentials. Simulates insider threat.",
                "Low to none — information already provided."
              ],
              [
                "**Partially Known**",
                "Hybrid — testers receive limited info (some IP ranges, some endpoints). Simulates an attacker with partial insider knowledge.",
                "Moderate — fills knowledge gaps."
              ],
              [
                "**Unknown**",
                "Testers receive minimal/no info (only company name or web domain). Simulates a real external attacker.",
                "Extensive — starts with full reconnaissance."
              ]
            ]
          }
        ],
        ...
        "tables": [
          {
            ...
            "rows": [
              [
                "**Exploits**",
                "~2,200",
                "Code that delivers a payload and attacks a specific vulnerability on a target system"
              ],
              [
                "**Auxiliary**",
                "~1,100",
                "Scanners, sniffers, fuzzers, spoofers, and other non-exploit features (e.g., port scanning)"
              ],
              [
                "**Post**",
                "~400",
                "Post-exploitation tasks on a compromised host (persistence, data exfiltration, pivoting)"
              ],
              [
                "**Payloads**",
                "~600",
                "Code that exploits deliver and run — grants control, elevated permissions, or a shell"
              ],
              [
                "**Encoders**",
                "45",
                "Ensure payloads reach the destination intact and undetected (bypass IDS, firewalls, ACLs)"
              ],
              [
                "**NOPs**",
                "10",
                "Non-operations — keep payload sizes consistent and assist with evasion"
              ],
              [
                "**Evasion**",
                "9",
          ...
          },
          {
            ...
            "rows": [
              [
                "`RHOST`",
                "Remote Host — IP address of the target"
              ],
              [
                "`RPORT`",
                "Remote Port — port on the target"
              ],
              [
                "`LHOST`",
                "Local Host — attacker machine IP (used by reverse payloads)"
              ],
              [
                "`LPORT`",
                "Local Port — listening port on attacker machine"
              ]
            ]
          },
          {
            ...
            "rows": [
              [
                "**Bind Shell**",
                "`command/unix/bind_perl`",
                "Opens a port on the target; attacker connects to it"
              ],
              [
                "**Reverse TCP Shell**",
                "`windows/x64/meterpreter/reverse_tcp`",
                "Target connects back to attacker (bypasses firewalls)"
              ]
            ]
          }
        ],
        ...
        "tables": [
          {
            ...
            "rows": [
              [
                ...
                "Findings + evidence proving the test occurred"
              ],
              [
                "**Evidence**",
                "Not necessarily included",
                "Required — logs, data, screenshots, exploit code shown"
              ],
              [
                "**Purpose**",
                "Guide the organization to fix issues",
                "Prove to a third party that the assessment was completed"
              ],
              [
                "**Evidence left with org?**",
                "Report delivered",
        ...
        "tables": [
          {
            ...
            "rows": [
              [
                ...
                "Validates the integrity of software using cryptographic techniques (e.g., verifying a digital signature on a software update to confirm it hasn't been tampered with)"
              ],
              [
                "**Hardware Attestation**",
                "Validates the integrity of hardware components (e.g., a TPM stores hardware/firmware measurements checked at boot time to detect unexpected changes)"
              ],
              [
                "**System Attestation**",
                "Validates the security posture of a system (e.g., a cloud provider attests that its services meet ISO 27001 or SOC 2 standards)"
              ]
            ]
          },
          {
            ...
            "rows": [
              [
                "**Internal Audits**",
                "Auditor attests accuracy of financial records, effectiveness of risk management, and adherence to internal policies"
              ],
              [
                "**External Audits**",
                "Independent third party attests financial statements, regulatory adherence, and operational efficiency"
              ]
            ]
          }
        ],
